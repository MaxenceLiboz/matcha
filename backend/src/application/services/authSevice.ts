import { CreateUserDTO, JWTTokenResponseDTO, LoginUserDTO, SendUserVerificationOrForgotPasswordDTO, UserResponseDTO, UserVerificationOrForgotPasswordDTO } from "@application/dtos/user.dto";
...
export class AuthService {
    ...
    async sendUserVerification(data: SendUserVerificationOrForgotPasswordDTO) : Promise<void> {
        const user = await this.userUseCases.getUserByUsernameAndEmail(data);
