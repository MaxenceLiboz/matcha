...
import { CreateUserSchema, LoginUserSchema, SendUserVerificationOrForgotPasswordSchema, UserVerificationOrForgotPasswordSchema } from "@application/dtos/user.dto";
...
authRoutes.post('/login', validationMiddleware(LoginUserSchema), (req, res, next) => authController.loginUser(req, res, next));
